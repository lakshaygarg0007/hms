...
//        model.addAttribute("totalAmount", totalAmount);
    ...
    public String deleteTransaction(@RequestParam(value = "serialNumber")int serialNumber,@RequestParam(value = "hotelId")String hotelId,@RequestParam(value = "amount")Double amount,@RequestParam(value = "date")@DateTimeFormat(pattern = "yyyy-MM-dd")Date date,@RequestParam("action") String action,Model model){
...
//           List<ManagerTransaction> managerTransactions=managerTransactionRepository.findBySerialNumber(serialNumber);
           System.out.println(date);
           ManagerTransaction manageTransaction=new ManagerTransaction(serialNumber,hotelId,amount,date,false);
           managerTransactionRepository.save(manageTransaction);
